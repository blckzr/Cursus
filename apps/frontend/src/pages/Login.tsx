      ...
      <div className="hidden lg:flex flex-col justify-between p-12 relative overflow-hidden bg-olive-600 text-white">
        ...
        <div className="relative">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-olive-200 text-[11px] uppercase tracking-widest mt-1">
        ...
        <div className="relative max-w-md">
          ...
          <p className="text-olive-100 text-sm mt-5 leading-relaxed max-w-sm">
            For administrators, faculty, and students — enrollments, grading
            periods, and the 1.00–5.00 PH grading scale built in.
          </p>
        </div>
      </div>
        ...
        <div className="w-full max-w-sm">
          <div className="lg:hidden text-center mb-6">
            <img
              src="/cursus-logo.svg"
              alt=""
              className="inline-block w-14 h-14 rounded-xl mb-3 shadow"
            />
            <h1 className="text-2xl font-semibold text-stone-800 font-display">
              Cursus
            </h1>
          </div>
          ...
          <div className="space-y-3 mt-4">
            <div className="bg-olive-50 dark:bg-olive-500/15 border border-olive-200 dark:border-olive-400/40 rounded-lg p-3 text-sm text-stone-700 dark:text-stone-200 flex items-start gap-2">
              <Icon
                name="check"
                size={14}
                className="mt-0.5 flex-shrink-0 text-olive-500 dark:text-olive-200"
              />
              <div>
                <div className="font-semibold">Request submitted.</div>
                <div className="text-xs mt-0.5">
                  If the user code you entered exists, an administrator has been
                  notified. You'll receive an in-app notification — or you can
                  simply try signing in with the default password — once it's
                  approved.
                </div>
              </div>
            </div>
          ...
          <form onSubmit={submit} className="space-y-4 mt-4">
            <div>
              ...
              <p className="text-[11px] text-stone-400 dark:text-stone-500 mt-1">
                The 9–14 character code printed on your ID, e.g.{" "}
                <span className="font-mono">2026-00001-MN-2</span>.
              </p>
            </div>
            ...
            <div className="bg-beige-50 dark:bg-stone-800 border border-beige-200 dark:border-stone-700 rounded-lg p-3 text-[11px] text-stone-500 dark:text-stone-400 flex items-start gap-2">
              ...
              <span>
                For your safety we never confirm whether a user code exists.
                You'll see the same success message either way.
              </span>
            </div>
